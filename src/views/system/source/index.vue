  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="sourceList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              ...
              <el-table-column label="来源名称" align="center" prop="name" />
      <el-table-column label="数量" align="center" prop="count" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:source:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:source:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="sourceRef" :model="form" :rules="rules" label-width="80px">
                        <el-form-item label="来源名称" prop="name">
...
<script setup name="Source">
  ...
  function handleDelete(row) {
    ...
    proxy.$modal.confirm('是否确认删除提交单位编号为"' + _ids + '"的数据项？').then(function() {
      return delSource(_ids);
    }).then(() => {
      getList();
  ...
  function handleExport() {
    proxy.download('system/source/export', {
      ...queryParams.value
